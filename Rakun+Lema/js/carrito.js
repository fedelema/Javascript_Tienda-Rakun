function cargarProductosCarrito() {
    ...
    let total = 0;
    let contenido = `<table class="table text-white">`;
    contenido += `
                <thead>
                <tr>
                <th scope="col">&nbsp;</th>
    ...
    for (let modelo of productos_carrito) {
        contenido += `
                    ...
                    <td><img src="../disenos/${modelo.img}" alt="${modelo.img}" width="80"></td>
    ...
    contenido += `
                ...
                <div class="col-md-9"></div>
                <div class="col-md-3">
                <a href="disenos.html"><button id="fincompra" class="btn btn-dark">Seguir Comprando</button></a>
                </div>
                </div>
                `;
...
function eliminarCarrito() {
    ...
    document.getElementById("carrito").innerHTML = `
                ...
                <a href="disenos.html" class="text-center"><button class="btn btn-dark">Volver a comprar</button></a>
    `;
}
