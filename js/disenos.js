...
for (let diseno of disenos_remeblancas2) {
    ...
    divRemeBlancas.innerHTML = `<div class="card text-center border-2 border-dark">
...
for (let diseno of disenos_remegrises2) {
    ...
    divRemeGrises.innerHTML = `<div class="card text-center border-2 border-dark">
                                    <img src="disenos/${prod.img}" class="card-img-top" alt="${prod.nombre}">
                                    <span class="img visually-hidden">disenos/${prod.img}</span>
                                    <div class="card-body bg-dark text-white">
                                        <h5 class="card-title">$ ${prod.precio}</h5>
...
for (let diseno of disenos_tazas2) {
    ...
    divTazas.innerHTML = `<div class="card text-center border-2 border-dark">
                                <img src="disenos/${prod.img}" class="card-img-top" alt="${prod.nombre}">
                                <span class="img visually-hidden">disenos/${prod.img}</span>
                                <div class="card-body bg-dark text-white">
                                    <h5 class="card-title">$ ${prod.precio}</h5>
...
function buscar() {
    ...
    $("#divs-buscados").prepend(`
            <div class="row">
                ...
                <div>
                    <button id="boton-volver" class="btn btn-dark"><a class="text-white text-decoration-none" href="index.html">Volver</a></button>
                </div>
            </div>
            `);
}
